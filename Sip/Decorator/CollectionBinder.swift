...
fileprivate class CollectionBinding<UnderlyingBinding, CollectionType>: DelegatedBinding, BindingBase where CollectionType: CollectionBindingResult, UnderlyingBinding: BindingBase, UnderlyingBinding.Element: ProviderBase, UnderlyingBinding.Element.Element == CollectionType.Element {
